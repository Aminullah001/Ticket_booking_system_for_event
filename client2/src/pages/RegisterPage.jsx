...
export default function RegisterPage() {
  ...
  return (
    ...
    <div className ="flex w-full h-full lg:ml-24 px-10 py-10 justify-between place-items-center mt-20" style={{ backgroundImage: 'url(../src/assets/pic2.jpeg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center' }}>
      <div className= "hidden lg:flex flex-col right-box ">
        <div className="flex flex-col gap-3">
        <div className="text-3xl font-black" style={{ color: 'white' }}>Welcome to paramount Event center</div>

          <div>
            {/* <img src="../src/assets/logo.jpg" alt="" className="w-48"/> */}
          </div>  
        </div>

        <div className="ml-18 w-100 mt-2">
        {/* <img src="../src/assets/signuppic.svg" alt="" className='w-full'/> */}
        <img src="../src/assets/pic2.jpeg" alt="" className='w-full'/>
        </div>   
