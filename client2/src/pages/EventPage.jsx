...
export default function EventPage() {
  ...
  const handleFacebookShare = () => {
    const linkToShare = window.location.href;
    const facebookShareUrl = `https://www.facebook.com/paramounteventvenue/${encodeURIComponent(linkToShare)}`;
  ...
  return (
    <div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
     <div >
      ...
      <div className="mx-2">
          <h2 className="text-md md:text-xl font-bold mt-3 text-primarydark">{event.ticketPrice === 0? 'Free' : 'Naira: '+ event.ticketPrice}</h2>
      </div>
